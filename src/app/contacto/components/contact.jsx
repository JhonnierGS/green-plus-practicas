...
import { Map, Arrow } from '../../../ui/icons';
...
const closeModal = () => {
    ...
    setFormData({ name: '', correo: '', mensaje: '' });
    setIsChecked(false);
};

return (
	<>
	<section className="w-full flex flex-col lg:flex-row items-center justify-center bg-contacto bg-cover bg-center bg-no-repeat px-[32px] lg:px-[82px] pt-[120px] pb-[82px]">
		<div className="w-full max-w-[1060px] flex flex-col gap-[clamp(80px,8vw,104px)] text-neutral-100">
			<div className="w-full flex flex-col gap-[16px] ">
				<h2 className='w-full font-semibold text-[clamp(24px,5vw,48px)] leading-auto'>
					Contactanos
				</h2>
				<p className='w-full max-w-[450px] text-[16px] leading-[25.5px]'>
					Para recibir más información sobre nosotros, nuestro propósito e inversiones compártenos tus datos y nos pondremos en contacto contigo.
				</p>
			</div>
			<div className="w-full flex flex-col gap-[20px] ">
				<h2 className='w-full font-semibold text-[22px] max-lg:hidden leading-[26px]'>
					Encuéntranos también en: 
				</h2>
				<div className='w-full max-w-[450px] flex gap-[16px]'>
					<figure>
						<Map className="w-[18px] h-[19px]" />
					</figure>
					<div className='w-full flex flex-col '>
						<p className='w-full font-semibold text-[34px] max-lg:hidden leading-[32px]'>
							Dirección:
						</p>
						<p className='w-full text-[19px] leading-[31.5px]'>
							Calle Alfonso XI, 7, 5to Izquierda, Madrid- España.
						</p>
					</div>
				</div>
			</div>	
		...
		<div className="w-full max-w-[540px] bg-neutral-100 rounded-[16px] p-[58px]  gap-[28px] lg:flex flex-col justify-center hidden">
				<h3 className="w-full max-w-[185px] text-neutral-1100 font-semibold text-[34px] lg:text-[24px] leading-[28px]">
					Pongámonos en contacto
				</h3>
				
				<form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4 my-[24px]">
					<div className="w-full max-w-[424px] flex flex-col gap-[23px]">
					...
					<div className="w-full max-w-[424px] flex gap-2 ">
					...
					<div className="w-full max-w-[424px] flex items-center  gap-3">
						<button
							type="submit"
