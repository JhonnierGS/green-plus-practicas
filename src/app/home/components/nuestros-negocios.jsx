...
export const NuestrosNegocios = () => {
  return (
    <section className='min-h-[809px] max-w-[2000px] flex justify-between mx-auto flex-col _900:flex-row'>
			...
			<div className="w-full min-h-[466px] flex items-center bg-bgng bg-center bg-cover bg-no-repeat px-[16px]">
				<div className="w-full flex flex-col gap-[32px] lg:gap-[64px] items-center">
					...
					<div className="w-full max-w-[600px]">
						<h2 className="text-[clamp(28px,2vw,34px)] text-neutral-100 font-semibold lg:leading-[37.8px] leading-[32px]">
