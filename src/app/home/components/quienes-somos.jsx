  ...
  return (
	<section className='flex justify-center '>
		<div className='w-full max-w-[1920px] flex flex-col-reverse lg:flex-row items-center '>
			<div className="w-full max-w-[1184px] flex flex-col lg:gap-[48px] gap-[32px] items-center pt-[40px] pb-[64px] lg:py-[80px] lg:px-[80px] px-[16px] border-t-1 border-darken-black-29">
